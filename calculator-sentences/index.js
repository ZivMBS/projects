...
const dictionary = [
    ...
    //special characters
    {key: "(", value: "ERCEIQQQ"}, {key: ")", value: "QQQhCERA"},
    {key: "-", value: "AAAPgAAA"}, {key: " ", value: "AAAHAAAA"},
    {key: ":", value: "AxgAMYAA"}, {key: ".", value: "AAAAAAxg"},
    {key: ",", value: "AAAAMYRA"}, {key: "!", value: "IQhCEAQg"}
];

button.addEventListener("click", () => {generate(input.value)});
input.addEventListener("input", evt => {generate(input.value)});
input.addEventListener("keydown", evt => {evt.keyCode == 13 ? generate(input.value) : false});
